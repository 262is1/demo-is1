...
Workspace de documentación del curso **Ingeniería de Software I** (IS1),
UPeU 2026-2. Este repo es solo de documentación (MkDocs): no hay código de
referencia dentro de este repositorio.

## Dónde está cada cosa

- `docs/silabo_is1_2026_2.md` — sílabo oficial **vigente** (no editar salvo
  pedido explícito; construido con temas de SWEBOK, Scrum y OpenUP).
  `docs/silabo_is1_2026_1.md` es la versión de ciclo anterior, solo como
...
- `docs/index.md` — **estado actual: contiene una transcripción del sílabo
  ...
  curso), no duplicar el contenido de `silabo_is1_2026_2.md`.
- `mkdocs.yml` — nav con "Inicio" y "Sílabos" (2026-1/2026-2) únicamente.

## Convenciones

- No editar los archivos `silabo_is1_*.md` salvo que se pida explícitamente.
